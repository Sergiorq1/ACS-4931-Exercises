...
class Recipe:
    def __init__(self, name, time, type, cuisine, ingredients, instructions, veggie=False):
        self.name = name
        self.time = time
        self.type = type
    ...
    def print_all(self):
        ...
        print("Prep time:",self.time, "mins")
        print("Is Veggie?", 'Yes' if self.veggie else "No")
...
foods = {'butternut squash soup':[45, True, 'soup','North African',\
     ['butter squash','onion','carrot', 'garlic','butter','black pepper', 'cinnamon','coconut milk']\
        ...
        'Home-made Beef Sausage': [60, False, 'deli','All',['sausage casing', 'regular ground beef','garlic',\
            'coriander seeds','black pepper seeds','fennel seed','paprika'],'1. In a blender,'
                ' blend coriander seeds, black pepper seeds, fennel seeds and garlic to make'
...
for key, value in foods.items():
    recipes = Recipe(key, value[0], value[2], value[3], value[4], value[5], value[1])
    recipes.print_all()
